...
def _collect_rollouts(
    ...
    *,
    ...
    result = generate_self_debug_rollouts(
        ...
        temperature=config.rollout.temperature,
        top_p=config.rollout.top_p,
        revision_max_new_tokens=config.self_debug.revision_max_new_tokens,
        revision_temperature=config.self_debug.revision_temperature,
        revision_top_p=config.self_debug.revision_top_p,
        include_hidden=config.include_hidden,
