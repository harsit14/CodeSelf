...
class GRPOOnlineEvaluationConfig:
    """Dev-evaluation settings for online GRPO cycles."""
...
class GRPOOnlineTrainingConfig:
    ...
    evaluation: GRPOOnlineEvaluationConfig | None = None
...
@dataclass(frozen=True)
class GRPOOnlineEvaluationResult:
    """Evaluation rollouts and summary for one online cycle."""
...
class GRPOOnlineTrainingStep:
    ...
    evaluation: GRPOOnlineEvaluationResult | None = None
...
def run_grpo_online_training(
    ...
    *,
    ...
    if eval_task_list and eval_config is None:
        eval_config = GRPOOnlineEvaluationConfig()
...
def _run_cycle_evaluation(
    ...
    *,
    ...
    config: GRPOOnlineEvaluationConfig,
    ...
    return GRPOOnlineEvaluationResult(
        cycle=cycle,
        seed=seed,
