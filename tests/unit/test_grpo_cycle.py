...
class GRPORolloutTrainingCycleTests(unittest.TestCase):
    def test_config_resolves_rollout_token_limits_into_batch_config(self) -> None:
        ...
        with self.assertRaises(ValueError):
            GRPORolloutTrainingCycleConfig(seed=-1)
    ...
    def test_cycle_collects_rollouts_trains_and_writes_artifacts(self) -> None:
        ...
        self.assertAlmostEqual(result.rollout_batch.groups[0].advantages[0], -1.0)
        self.assertAlmostEqual(result.rollout_batch.groups[0].advantages[1], 1.0)
